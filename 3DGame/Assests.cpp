...
std::map<std::string, Texture> Assets::textures; //because it static you define it
...
Shader Assets::loadShader(const string& vShaderFile, const string& fShaderFile, const string& tcShaderFile, 
...
Shader Assets::loadShaderFromFile(const string& vShaderFile, const string& fShaderFile, const string& tcShaderFile, 
